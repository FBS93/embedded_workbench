...
The `hw/cross_domain_interfaces/` folder contains the cross-domain interface work products generated by the `hw-implementation` process (only Markdown documents: `.md`).
