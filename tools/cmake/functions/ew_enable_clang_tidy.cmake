...
function(ew_enable_clang_tidy)
  ...
  if(NOT EXISTS "${ew_clang_tidy_config}")
    message(
      FATAL_ERROR
      "clang-tidy config file not found: ${ew_clang_tidy_config}"
    )
  endif()
  ...
  if(ew_clang_tidy_target)
    list(
      APPEND ew_clang_tidy_command
      "--extra-arg-before=--target=${ew_clang_tidy_target}"
    )
  endif()
  ...
  if(ew_clang_tidy_sysroot AND IS_DIRECTORY "${ew_clang_tidy_sysroot}")
    list(
      APPEND ew_clang_tidy_command
      "--extra-arg-before=--sysroot=${ew_clang_tidy_sysroot}"
    )
  endif()
